...
import { LIGHTNING_ADDRESS, MILLISATS_PER_MESSAGE } from '@/utils/app/const';
import { InvoiceModal } from '@/components/Lightning/InvoiceModal';
    ...
    <>
      {showInvoiceModal && (
        <InvoiceModal
          ...
          onSuccess={onSuccess} // Replace this with the function to execute when the payment is successful
        />
      )}
